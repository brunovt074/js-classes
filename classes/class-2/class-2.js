 ...
 *
 * Trabajas como analista en un fondo de inversión.
 * Tienes una lista de diferentes acciones (activos) y necesitas procesar los datos
 * para tomar decisiones financieras rápidas usando JavaScript.
 */


/**
 * 1. Bucle de control (7 días)
 * El mercado está abierto y queremos simular el paso del tiempo.
 * Consigna: Crea un bucle que represente los primeros 7 días del mes.
 * En cada vuelta, debe mostrar por consola: *
 * "Día [número]: Analizando tendencias...".
**/
for (let i = 1; i <= 7; i++) {
...
/**
 * 2. Actualización por Inflación (Uso de .map)
 * Tienes la siguiente lista con los precios actuales de algunas acciones tecnológicas:
 **/
const acciones = [1500, 2800, 1200, 4500];
/**
 * Consigna: Debido a un ajuste en el mercado, todas las acciones subieron un 15%.
 * Usa .map para crear un nuevo array llamado preciosActualizados
 * que refleje este aumento (multiplicar por 1.15).
 **/
const preciosActualizados = acciones.map(p => p * 1.15);

// 3. Filter – Empresas unicornio
// Ahora tienes una lista de empresas con su valor de mercado actual:
const empresas = [
...
/**
 * Consigna: Tu jefe solo quiere invertir en empresas "Unicornio" (aquellas cuyo valor sea mayor a 5000).
 * Usa .filter para crear una lista llamada oportunidades
 * que refleje este aumento (multiplicar por 1.15).
**/
 ...
 * procesaremos una lista de activos que incluyen su nombre y su rentabilidad anual.
 */
...
/**
 * Tu tarea:
 * 1 - Filtrar: Crea una lista llamada buenosActivos que solo contenga los que tengan una rentabilidad mayor a 10.
 * 2 - Mapear: Sobre esa lista filtrada, crea un array que solo contenga los nombres de esos activos para el reporte.
 * 3 - Resultado: Muestra por consola los nombres de los activos recomendados.
 * */
